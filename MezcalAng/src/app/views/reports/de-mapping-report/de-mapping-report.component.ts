...
@Component({
  selector: 'app-de-mapping-report',
  templateUrl: './de-mapping-report.component.html',
  styleUrls: ['./de-mapping-report.component.scss']
})
...
this.selectedColumns = this.cols;
  ...
  getLazyLoadUsers(event: any): any {
    ...
    this.api.postApi('Mapping/GetDeMappingListForGrid',event).subscribe((res: any) => {
...
//////// Get Order List for Excel

getLazyLoadLblPrintForExport(event: any) {
  this.api.postApi( 'Mapping/GetDeMappingListForGrid',event).subscribe((response: any) => {
    ...
    if (response.responseCode == 200) {
      ...
      this.ExcelReportResult.slice();
        ...
        this.excelService.exportAsExcelFile(this.ExcelReportResult, 'Reporte De Productos Desmapeados  - ' + new Date());
